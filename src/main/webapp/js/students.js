	...
	$('#filter_check_in-end').datepicker({
	    changeMonth: true,
	    changeYear: true,
	    dateFormat : 'dd-M-yy',
		prevText : '<i class="fa fa-chevron-left"></i>',
		nextText : '<i class="fa fa-chevron-right"></i>',
		onSelect : function(selectedDate) {
			$('#filter_check_out-end').datepicker('option', 'minDate', selectedDate);
			$('#filter_check_in-end').focus();
		}
		});

	$('#filter_check_out-end').datepicker({
	    changeMonth: true,
	    changeYear: true,
	    dateFormat : 'dd-M-yy',
		prevText : '<i class="fa fa-chevron-left"></i>',
...
//
	...
	$(".text-filter").blur(function(){
		...
		if (($(this).hasClass( "datepicker") && $(this).val() != "") | (!$(this).hasClass( "datepicker"))){
			var valueFilters = "";
			...
			if (filters != localStorage.getItem("filters")){
			    ...
			    console.log ("2 - filtro " + new Date().getTime());	
			};
		};
	});	
