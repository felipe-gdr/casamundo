 ...
 */
    ...
    function rest_changeStatus(idStudent, action_notOk, objJson ) {
		$.ajax({
			type: "POST",
            url: "http://" + localStorage.urlServidor + ":8080/casamundo/rest/student/changeStatus?",
            contentType: "application/json; charset=utf-8",
            dataType: 'json',
            data : JSON.stringify(objJson),
            async:false    	
    ...
    function rest_allocate_room_family (objJson){
    	var result = false;
		$.ajax({
			type: "POST",
            url: "http://" + localStorage.urlServidor + ":8080/casamundo/rest/family/allocate/room",
            contentType: "application/json; charset=utf-8",
            dataType: 'json',
            data : JSON.stringify(objJson),
            async:false    	
    ...
    function rest_deallocate_room_family (objJson){
    	var result = false;
		$.ajax({
			type: "POST",
            url: "http://" + localStorage.urlServidor + ":8080/casamundo/rest/family/deallocate/room",
            contentType: "application/json; charset=utf-8",
            dataType: 'json',
            data : JSON.stringify(objJson),
            async:false    	
    ...
    function rest_atualizaInvoice(documento){
    	var dataReturn = null;
		$.ajax({
			type: "POST",
    ...
    function rest_incluiInvoice(documento){
    	var dataReturn = null;
		$.ajax({
			type: "POST",
    ...
    function rest_excluiInstallmentInvoice(objJson, action_ok, action_notOk, messageOk, messageNotOk) {
		$.ajax({
			type: "POST",
    ...
    function rest_incluiInstallmentInvoice(objJson, action_ok, action_notOk, messageOk, messageNotOk, var1) {
		$.ajax({
			type: "POST",
...
//
    ...
    function rest_invoice_get_number() {
    	var  number = "0/0000";
    	$.ajax({
    ...
    function call_rest_get(rest, params){
    	
    	var result = null;
    	$.ajax({
            url: localStorage.mainUrl + "casamundo/rest/" + rest + "?" + params,
            contentType: "application/json; charset=utf-8",
            dataType: 'json',
            async:false
    	})
    ...
    function call_rest_post(rest, objJson){
    	var result = null;
		$.ajax({
			type: "POST",
    		url : localStorage.mainUrl + "casamundo/rest/" + rest,
    		contentType : "application/json; charset=utf-8",
    		dataType : 'json',
    		async : false,
            data : JSON.stringify(objJson)
